...
This example will manage the Hetzner Cloud server and creates a single server without a private IP address.

## Graph

<img alt="Graph" src="https://github.com/dhoppeIT/terraform-hcloud-server/blob/main/examples/single_server_public/rover.svg?raw=true" width="100%" height="100%">
