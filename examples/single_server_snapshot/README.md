...
This example will manage the Hetzner Cloud server and creates a single server with snapshot.

## Graph

<img alt="Graph" src="https://github.com/dhoppeIT/terraform-hcloud-server/blob/main/examples/single_server_snapshot/rover.svg?raw=true" width="100%" height="100%">
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_hcloud_server"></a> [hcloud\_server](#module\_hcloud\_server) | dhoppeIT/server/hcloud | ~> 0.2 |
