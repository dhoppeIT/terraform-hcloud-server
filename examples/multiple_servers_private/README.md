...
This example will manage the Hetzner Cloud server and creates multiple servers with a private IP address.

## Graph

<img alt="Graph" src="https://github.com/dhoppeIT/terraform-hcloud-server/blob/main/examples/multiple_servers_private/rover.svg?raw=true" width="100%" height="100%">
